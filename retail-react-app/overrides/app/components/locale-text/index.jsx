...
const LOCALE_MESSAGES = defineMessages({
    ...
    fr: {id: 'locale_text.message.fr', defaultMessage: 'French'},
    de: {id: 'locale_text.message.de', defaultMessage: 'German'},
    es: {id: 'locale_text.message.es', defaultMessage: 'Spanish'},
    nl: {id: 'locale_text.message.nl', defaultMessage: 'Dutch'},
    en: {id: 'locale_text.message.en', defaultMessage: 'English'}
})

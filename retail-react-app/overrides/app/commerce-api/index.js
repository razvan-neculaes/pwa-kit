 ...
 */
import OcapiShopperStores from './ocapi-stores'
/* eslint-disable no-unused-vars */
import * as sdk from 'commerce-sdk-isomorphic'
import {getAppOrigin} from '@salesforce/pwa-kit-react-sdk/utils/url'
import OcapiShopperPreferences from './ocapi-shopper-preferences'
...
class CommerceAPI {
    ...
    constructor(config = {}) {
        ...
        const apiConfigs = {
            ...
            shopperStores: {api: OcapiShopperStores},
            shopperPreferences: {api: OcapiShopperPreferences}
        }

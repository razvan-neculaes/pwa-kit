...
/************ SiteCode ************/
export const SiteCodeContext = createContext()
export const SiteCodeProvider = SiteCodeContext.Provider

/************ CommonInfo ************/
export const CommonInfoContext = createContext()
export const CommonInfoProvider = CommonInfoContext.Provider

/************ Site Preferences ************/
export const SitePreferencesContext = createContext()
export const SitePreferencesProvider = SitePreferencesContext.Provider

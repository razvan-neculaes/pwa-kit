...
import FooterIKKS from './components/sites/footer-ikks'
import FooterICODE from './components/sites/footer-icode'
import StoreLocatorResultsIKKS from './components/sites/store-locator-results-ikks'
import StoreLocatorResultsICODE from './components/sites/store-locator-results-icode'
import StoreLocatorInformationIKKS from './components/sites/store-locator-information-ikks'
import StoreLocatorInformationICODE from './components/sites/store-locator-information-icode'
import StoreLocatorSearchIKKS from './components/sites/store-locator-search-ikks'
import StoreLocatorSearchICODE from './components/sites/store-locator-search-icode'
import StoreLocatorTimetableIKKS from './components/sites/store-locator-timetable-ikks'
import StoreLocatorTimetableICODE from './components/sites/store-locator-timetable-icode'
import StoreLocatorStoresNearIKKS from './components/sites/store-locator-stores-near-ikks'
import StoreLocatorStoresNearICODE from './components/sites/store-locator-stores-near-icode'
import StoreLocatorDetailsIKKS from './components/sites/store-locator-details-ikks'
import StoreLocatorDetailsICODE from './components/sites/store-locator-details-icode'
import StoreLocatorBreadcrumbIKKS from './components/sites/store-locator-breadcrumb-ikks'
import StoreLocatorBreadcrumbICODE from './components/sites/store-locator-breadcrumb-icode'
